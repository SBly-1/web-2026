    ...
    <body>
        <div class="page">
            ...
            <main class="post-form">
                <div class="post-form__content">
                    <div class="post-form__media">
                        ...
                        <div class="post-form__slider" hidden>
                            <button class="post-form__remove-photo-button" type="button" aria-label="Удалить фото">×</button>
                    ...
                    <div class="post-form__error-message" hidden>
                        <span>😔</span>
                        <span class="post-form__error-text">Не удалось сохранить пост</span>
                    </div>
                ...
                <p class="post-form__success-message" hidden>Пост успешно сохранен!</p>
            </main>
        </div>
    </body>
</html>